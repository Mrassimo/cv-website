  ...
  return (
    <div className="relative pl-32 pb-32">
      ...
      >
        ...
        <h3 className="text-h3 text-primary mt-8">{experience.role}</h3>
        <div className="flex items-center gap-8 mt-8">
           <experience.logo className="w-5 h-5 text-secondary flex-shrink-0" />
           <h4 className="font-semibold text-body text-secondary">{experience.company} &bull; {experience.location}</h4>
        </div>
        <ul className="mt-16 space-y-8 list-disc list-inside text-body text-primary">
  ...
  return (
    <Section id="experience" ref={ref}>
      <div className="w-full max-w-4xl mx-auto">
        <h2 className="text-h2 text-primary text-center mb-8">Professional Experience</h2>
