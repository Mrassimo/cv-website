...
export const VectorDbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (<Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375c0 1.035-5.033 1.875-11.25 1.875S-2.25 7.41-2.25 6.375m22.5 0c0-1.035-5.033-1.875-11.25-1.875S-2.25 5.34-2.25 6.375m22.5 0v9c0 1.035-5.033 1.875-11.25 1.875S-2.25 16.41-2.25 15.375v-9m22.5 4.5v4.5" fill="none" stroke="currentColor" strokeWidth={1.5} /><circle cx="18" cy="18" r="2.5" fill="none" stroke="currentColor" strokeWidth={1.5} /><path strokeLinecap="round" strokeLinejoin="round" d="M15.5 17.5L13 15m8.5 5.5L19 18" fill="none" stroke="currentColor" strokeWidth={1.5} /></Icon>);
export const SemanticSearchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (<Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" fill="none" stroke="currentColor" strokeWidth={1.5} /><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3m0 0h3m-3 0V9m0 3v3" fill="none" stroke="currentColor" strokeWidth={1.5} /></Icon>);
